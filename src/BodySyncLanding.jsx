  ...
  return (
    <div className="bg-gray-50 text-gray-900 font-orbitron">
      ...
      <section id="signup" className="py-24 text-center bg-primary text-white px-6">
        ...
        <form action="https://bodysync.us4.list-manage.com/subscribe/post?u=1eaa0662e66a1eb9e038f41d4&amp;id=01cd275114&amp;f_id=006a64e2f0" method="post" target="_blank" className="flex flex-col md:flex-row justify-center items-center gap-4 max-w-xl mx-auto">
